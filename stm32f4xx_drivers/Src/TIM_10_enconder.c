...
int main(void)
{
	...
	uint8_t msg[48];
	htim2.pTIMx->ARR = 100;//contara hasta 100 y hara un overflow y regresara a 0 [opcional]
	while(1){

		tim2_cnt = TIM_GetCounter(htim2.pTIMx);//valor actual del registro de contaje
		dir = (htim2.pTIMx->CR1 >> TIM_CR1_DIR) & 0x01;//obtener la direccion
